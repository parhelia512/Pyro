...
procedure Video02_VideoStatusEvent(const ASender: Pointer; const AStatus: TPyVideoStatus; const AFilename: string);
begin
...
var
  ...
  LHudPos: TPyPoint;
begin
  LWindow := TPyWindow.Init('Pyro: Video #02');

  LFont := TPyFont.Init(LWindow, 10);

  PyVideo.SetStatusEvent(nil, Video02_VideoStatusEvent);
  PyVideo.PlayFromZipFile(CZipFilename, 'res/videos/pyro.mpg', 1.0, False);
